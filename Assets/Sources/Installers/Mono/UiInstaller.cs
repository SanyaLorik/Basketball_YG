...
namespace Basketball_YG.Installer
{
    public class UiInstaller : MonoInstaller
    {
        ...
        [SerializeField] private TextSetup _ballStoreTotalMoneyText;
        ...
        [SerializeField] private TextSetup _siteStoreTotalMoneyText;
        ...
        private void BindMainMenu()
        {
            ...
            Container
                .Bind<TextSetup>()
                .WithId(GameConstants.UiMainMenuMoneyText)
                .FromInstance(_moneyMain)
                .AsCached();
        ...
        private void BindPauseMenu()
        {
            ...
            Container
                .Bind<ClickedCallback>()
                .WithId(GameConstants.UiButtonRestartPauseMenu)
                .FromInstance(_restartPauseMenuButton)
                .AsCached();
        ...
        private void BindBallStoreMenu()
        {
            ...
            Container
                .Bind<TextSetup>()
                .WithId(GameConstants.UiBallStoreTotalMoneyText)
                .FromInstance(_ballStoreTotalMoneyText)
                .AsCached();
        ...
        private void BindSiteStoreMenu()
        {
            ...
            Container
                .Bind<TextSetup>()
                .WithId(GameConstants.UiSiteStoreTotalMoneyText)
                .FromInstance(_siteStoreTotalMoneyText)
                .AsCached();
